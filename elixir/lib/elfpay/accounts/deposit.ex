defmodule Elfpay.Accounts.Deposit do
  alias Ecto.Multi
  alias Elfpay.{Account, Repo}
  ...
  def handle_cast({:ok, value}, balance), do: Decimal.add(value, balance)
  def handle_cast(:error, _balance), do: {:error, "Invalid deposit value!"}
