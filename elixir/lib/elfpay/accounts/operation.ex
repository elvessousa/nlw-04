defmodule Elfpay.Accounts.Operation do
  alias Ecto.Multi
  ...
  def handle_cast({:ok, value}, balance, :deposit), do: Decimal.add(balance, value)
  def handle_cast({:ok, value}, balance, :withdraw), do: Decimal.sub(balance, value)
  def handle_cast(:error, _balance, _operation), do: {:error, "Invalid deposit value!"}
